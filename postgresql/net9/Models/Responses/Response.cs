...
public class Response<T>
{
    ...
    public BodyResponse<T> BodyResponse { set; get; }
    public Response(int httpStatusCode, BodyResponse<T> bodyResponse)
    {
...
public static class ResponseHelper {
    ...
    {
        return new Response<T>(204, new BodyResponse<T>(default, null));
    }
